 ...
 *   3) createConfigurationView  module-owned UI (vanilla DOM)
 *
...
import { createConfigurationView as InternalView } from "./configuration.view";
...
export const DEFAULT_CONFIG: ConfigurationShape = {
  appTitle: "wMEP Modular Demo (ESM)",
  theme: "light",
  layout: {
...
export const createConfigurationView = InternalView;
