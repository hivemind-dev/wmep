 ...
 *                  right-side buttons
 *
 * The boundary exports the contract, the factory, and the
 * vanilla-DOM view factory that renders the whole shell.
 */
...
import { createLayoutView as InternalView } from "./layout.view";
...
export const createLayoutView = InternalView;
