 ...
 *
 * Pure state machine for the layout shell. The vanilla-DOM view in
 * layout.view.ts reads this state and renders the actual top-bar /
 * side-panels / page-area DOM.
 *
